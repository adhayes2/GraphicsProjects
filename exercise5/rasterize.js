// https://pages.github.ncsu.edu/adhayes2/exercise5/
    ...
    if (inputTriangles != String.null) { 
        ...
        for (var whichSet=0; whichSet<inputTriangles.length; whichSet++) {
            ...
            for (whichSetVert=0; whichSetVert<inputTriangles[whichSet].vertices.length; whichSetVert++) {
                ...
                //console.log( typeof vtxToAdd[0] );
                vtxToAdd[1] = vtxToAdd[1] * -1; //upside down
...
function setupShaders() {
    ...
    var fShaderCode = `
        void main(void) {
            gl_FragColor = vec4(1.0, .007, .576, 1.0); // all fragments are DEEP PINK
        }
    `;
    ...
    var vShaderCode = `
        ...
        void main(void) {
            gl_Position = vec4(vertexPosition, 5.0); // DON'T use the untransformed position
        }
    `;
