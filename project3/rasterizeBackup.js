...
var blend = 0; //0 = replace, 1 = multiply, 2 = two textures multiplied, 3 = two textures multiplied and color
            ...
            if (numLongSteps % 2 != 0)
                ...
                for (var latAngle=-latLimitAngle; latAngle<=latLimitAngle; latAngle+=angleIncr) {
                    ...
                    for (var longAngle=0; longAngle<2*Math.PI+angleIncr; longAngle+=angleIncr) {// for each long
                        ...
                        ellipsoidTextures.push( longAngle/(Math.PI * 2), 1-(latAngle+latLimitAngle)/(Math.PI) );
                    }
        ...
        if (inputTriangles == String.null)
            ...
            for (var whichSet=0; whichSet<numTriangleSets; whichSet++) { // for each tri set
                ...
                for (whichSetVert=0; whichSetVert<numVerts; whichSetVert++) { // verts in set
                    ...
                    //texture stuff
                    inputTriangles[whichSet].textureCoordinates.push( 1-inputTriangles[whichSet].uvs[whichSetVert][0], 1-inputTriangles[whichSet].uvs[whichSetVert][1] );
